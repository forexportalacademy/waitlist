...
export function Footer() {
    return (
        <footer className="relative pb-1">
            <div className="relative mx-auto px-5">
                <div className="relative overflow-hidden rounded-t-[28px] bg-black px-8 py-12 pb-6 text-white shadow-2xl">
                    <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr_1fr_1fr]">
                        ...
                        <div className="space-y-3 text-sm text-white/70">
                            ...
                            <p>Lagos, Nigeria</p>
                            <p>+234 906 442 4518</p>
                            <p>contact@forexportalacademy.net</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-10 flex flex-col items-start justify-between gap-6 text-sm text-white/60 md:flex-row md:items-center">
                        ...
                        <div className="flex items-center gap-4 text-white/70">
                            <a href="https://wa.link/tf3zia" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                            ...
                            <a href="https://www.instagram.com/forexportal?igsh=MWV6dndzenJtbDZocQ==" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
                            ...
                            <a href="https://t.me/m/dRRTIX5YNGVk" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
